...
class SoundWave {
    ...
    createMusicCatalog() {
        this.musicCatalog = [
            // Pop Music
            {
                ...
                year: 2019,
                duration: "3:20",
                image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSQNFYdVGeiEa8s2DVb4KnJmxmNQ6vsR24PQ&s",
        ...
        this.playlists = [
            {
                ...
                type: "Popular",
                image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSO5lkiuHPEocpXzaUHWC2__UY8o1eIyOkwNw&s",
                songCount: 50,
            ...
            },
            {
                ...
                type: "Fitness",
                image: "https://thumbs.dreamstime.com/b/dark-fitness-motivational-poster-text-beast-mode-gritty-background-sports-typography-design-beast-mode-dark-fitness-402062650.jpg",
                songCount: 40,
            ...
            },
            {
                ...
                type: "Genre",
                image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSZNURzSr8bOL26paw1-gEPPJxIoxVEOcZZg&s",
                songCount: 60,
            ...
            },
            {
                ...
                type: "Mood",
                image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZ3Y39jp9Nju_UoSWzbJswWvbSP3CGCqFkcQ&s",
                songCount: 25,
            ...
            },
            {
                ...
                type: "Genre",
                image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEeiou1bgZBlFC-v-wkJGIcl7gS-nMyk-tKQ&s",
                songCount: 45,
    ...
    setupEventListeners() {
        ...
        document.querySelectorAll('.nav-link').forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                this.closeMobileMenu(); // Close menu after clicking link
            });
        });
    ...
    createMusicCard(song) {
        ...
        card.innerHTML = `
            <div class="music-card-image">
                <img src= "${song.image} " alt="music-image" class="image">
    ...
    createPlaylistCard(playlist) {
        ...
        card.innerHTML = `
            <div class="playlist-card-image">
                <img src = "${playlist.image}" alt="music-image" class="image">
    ...
    createArtistCard(artist) {
        ...
        card.innerHTML = `
            <div class="artist-card-image">
                <img src= "${artist.image} " alt="music-image" class="image">
            </div>
    ...
    playMusic(songId) {
        ...
        this.showPlayer(song);
         /* this.showToast(`playing: ${song.title} by ${song.artist}`);  */
    }
        ...
        this.favorites.forEach(song => {
            ...
            favoriteItem.innerHTML = `
                <div class="favorite-item-image">
                    <img src = "${song.image}" class="images">
                </div>
